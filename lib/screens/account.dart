...
import 'package:active_ecommerce_seller_app/screens/currency/currency_change.dart';
          ...
          SizedBox(
            ...
            child: Buttons(
              onPressed: () {
                ...
                // MyTransaction(context: context).push( CurrencyChange());
              },
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Row(
                    children: [
                      Image.asset('assets/icon/currency.png',
                          width: 16,
                          height: 16,
                          color: MyTheme.app_accent_border),
                      const SizedBox(
